...
export default class About extends Component {
  render() {
    ...
    <img src="lucas-perfil.jpg" alt="perfil" className="perfil-img"/>
        ...
        <p className="text-body"> Front-End development with knowledge in technologies such as React, RTL testing, React with Redux, ContextAPI and ReactHooks, with experience working in groups with agile methodologies such as Kanban and Scrum.
